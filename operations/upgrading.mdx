---
title: "Upgrade Your Self-Hosted Tymeslot to a New Version"
sidebarTitle: "Upgrading"
description: "Pull the latest Docker image, let startup run migrations automatically, and handle the volume rename if upgrading an older Tymeslot install."
---
