---
title: "Tymeslot Environment Variable Reference"
...
<ParamField path="DATABASE_POOL_SIZE" type="integer" default="10">
  Ecto database connection pool size. The container entrypoint defaults this to `10`. Raise it for higher concurrency workloads and ensure your PostgreSQL `max_connections` is set higher than this value.
</ParamField>
