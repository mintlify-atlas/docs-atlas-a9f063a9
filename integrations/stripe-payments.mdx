---
title: "Accept Meeting Payments via Stripe Connect in Tymeslot"
sidebarTitle: "Stripe Payments"
description: "Enable optional paid bookings through Stripe Connect. Self-hosters register their own Stripe platform — Tymeslot never holds funds by default."
---
...
<Note>
  ...
  The Stripe environment variables are not included in the default `.env.example` template because this is an advanced optional feature. Add them manually to your `.env` file when setting up Stripe Connect.
</Note>
