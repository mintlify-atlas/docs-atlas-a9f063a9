...
- **Configure OAuth providers** — see the [Google OAuth](https://tymeslot.app/docs/google-oauth), [Microsoft OAuth](https://tymeslot.app/docs/microsoft-oauth), and [Generic OIDC/SSO](https://tymeslot.app/docs/oidc-sso) guides.
